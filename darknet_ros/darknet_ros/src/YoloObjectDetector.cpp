...
//  imageSubscriber_ = imageTransport_.subscribe(cameraTopicName, cameraQueueSize, &YoloObjectDetector::cameraCallback, this);
  ...
  imageSubscriber_ = imageTransport_.subscribe(cameraTopicName, cameraQueueSize, &YoloObjectDetector::cameraCallback, this, image_transport::TransportHints("compressed"));  
...
void *YoloObjectDetector::publishInThread()
{
  ...
  if (num > 0 && num <= 100) {
    ...
    boundingBoxesResults_.image_height = cvImage.size().height;
    boundingBoxesResults_.image_width = cvImage.size().width;
